    ...
    private void UpdateLineRenderer(LineRenderer lineRenderer, float slope, int lineIndex)
    {
        ...
        switch (lineIndex)
        {
            ...
            case 2:
                ...
                positions[0] = new Vector3(8.5f, 1.2f, -5.65f); // Start point
                positions[1] = new Vector3(8.5f - deltaY, 1.2f + (slope * deltaY), -5.65f); // End point
                break;
            case 3:
                deltaX = length / Mathf.Sqrt(1 + slope * slope);
                positions[0] = new Vector3(14.2f, 2.5f, -5.65f); // Start point
                positions[1] = new Vector3(14.2f - deltaX, 2.5f + (slope * deltaX), -5.65f); // End point
                break;
        }
